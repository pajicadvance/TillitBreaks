package me.pajic.tib.renderer;

import me.pajic.tib.TIBUtil;
import me.pajic.tib.compat.AccessorifyCompat;
import me.pajic.tib.compat.CompatFlags;
import me.pajic.tib.compat.NyfsQuiversCompat;
...
public class ItemTextRenderer {
    ...
    private static void renderArrowCounter(Minecraft minecraft, GuiGraphics guiGraphics, Font font, float scale, ItemStack stack) {
        ...
        if (CompatFlags.NYFS_QUIVERS_LOADED) NyfsQuiversCompat.addArrowsFromQuiver(minecraft.player, arrows);
